    ...
    with open(README_PATH, "a", encoding="utf-8") as f:
        for widget_name, dark_preview, light_preview in widgets:
            ...
            if dark_preview and light_preview:
                ...
                f.write(f"  > | <img src='previews/{light_preview}' alt='Light Preview' style='width:200px;'/> | <img src='previews/{dark_preview}' alt='Dark Preview' style='width:200px;'/> |\n")
                f.write("  > |-------|------|\n")
                f.write("  > | Light | Dark |\n")
            elif light_preview:
                # Only Light Mode available
                f.write(f"  > <img src='previews/{light_preview}' alt='Light Preview' style='width:200px;'/>\n")
            elif dark_preview:
                # Only Dark Mode available
                f.write(f"  > <img src='previews/{dark_preview}' alt='Dark Preview' style='width:200px;'/>\n")
